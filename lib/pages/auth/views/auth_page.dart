...
class _AuthPageState extends State<AuthPage> {
  late final AuthController _controller; //controller callback the page: I finish the task, you UI should move to next
          ...
          return SingleChildScrollView (
            ...
            child: ConstrainedBox(
              ...
              child: AuthBody(
                  ...
                  menuContent: TabletAuthCard(controller: _controller)
              ),
            ),
          );
        }
