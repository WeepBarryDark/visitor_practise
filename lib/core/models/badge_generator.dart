...
class BadgeGenerator {
  ...
  static const double qrCodeSize = 420.0; 
  ...
  static Future<ui.Image> generateBadgeImage(BadgeGenerator data) async {
    /*debugPrint(
  ...
  static double _calculateCanvasHeight(BadgeGenerator data) {
    double yPosition = 40;
